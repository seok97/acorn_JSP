...
<%@ page language="java" contentType="text/html; charset=UTF-8"
   ...
   */
   ...
   System.out.println("원본파일명 " + orgFileName);
   System.out.println("저장된파일명 : "+saveFileName);
...
<body>
	...
	<a href="download.jsp?fileSize=<%=fileSize %>&orgFileName=<%=orgFileName %>&saveFileName=<%=saveFileName %>">업로드 파일 다운</a>
	<h1>방금 업로드한 이미지</h1>
